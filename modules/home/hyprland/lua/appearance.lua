...
-- Combines end4's animations/rounding with user's gaps/border
-- Colors provided by Stylix via HYPRLAND_PALETTE env var

------------------
---- MONITORS ----
------------------

-- Your specific monitor setup
hl.monitor({
...
-- Nix generates this as a JSON string via palette.json
...
-- General: your gaps + end4's settings
hl.config({
    general = {
        gaps_in = 4,
        gaps_out = 5,
